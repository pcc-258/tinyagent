...
import "github.com/pcc-258/tinyagent/core"
...
type ToolCallAccumulator struct {
	byIndex map[int]*core.ToolCall
	order   []int
}

// NewToolCallAccumulator 创建一个空聚合器。
func NewToolCallAccumulator() *ToolCallAccumulator {
	return &ToolCallAccumulator{byIndex: make(map[int]*core.ToolCall)}
}
...
func (a *ToolCallAccumulator) Calls() []core.ToolCall {
	out := make([]core.ToolCall, 0, len(a.order))
