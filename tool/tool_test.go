...
func noopFn(ctx context.Context, p weatherParams) (core.ToolResult, error) {
...
func TestFuncTool_Run(t *testing.T) {
	tool := mustNewTool(t, "echo", "回显",
		func(ctx context.Context, p weatherParams) (core.ToolResult, error) {
			return core.ToolResult{Content: "city=" + p.City}, nil
		})
